...
If invoked outside the context of a local repo, the command will fail.",
            ...
            .subcommand(
                clap::SubCommand::with_name("create")
                    ...
                    .arg(
                        clap::Arg::with_name("pipeline_timeout")
                            .long("pipeline_timeout")
                            .takes_value(true)
                            .help("Sets timeout before killing CI/CD pipeline in minutes")
                    )
                    .arg(
                        clap::Arg::with_name("pipeline_coverage_regex")
                            .long("pipeline_coverage_regex")
                            .help("Sets regex to use to extract coverage stats from pipelines")
                            .takes_value(true)
                    )
                    .arg(
                        clap::Arg::with_name("ci_coverage_path")
                            .long("ci_coverage_path")
                            .help("Sets path to gitlab ci config file.")
                            .default_value(".gitlab-ci.yml")
                            .takes_value(true)
                    )
                    .arg(
                        clap::Arg::with_name("visibility_level")
                    ...
                    .arg(
                        clap::Arg::with_name("auto_devops_enabled")
                            .long("auto_devops_enabled")
